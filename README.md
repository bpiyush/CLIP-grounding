...
We'd like to thank the TAs, in particular, [Jaap Jumelet](https://jumelet.ai/) and [Tom Kersten](https://www.linkedin.com/in/tom-kersten-6277a7124/?originalSubdomain=nl), for useful initial discussions, and the course instructor [Prof. Jelle Zuidema](https://staff.fnwi.uva.nl/w.zuidema/).
...
* [Transformer multi-modal Explanability](https://github.com/hila-chefer/Transformer-MM-Explainability) by [Hila Chefer](https://github.com/hila-chefer) et al.
